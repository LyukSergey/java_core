...
@SpringBootTest(classes = {ImmutableWrongDemoApplication.class,
        ...
        properties = {"spring.main.allow-bean-definition-overriding=true", "app.mutable=true"})
class AccountControllerMutableIntegrationTest {
    ...
    void calculatePortfolio_ShouldReturnExpectedResponse() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/mutable/portfolio"))
