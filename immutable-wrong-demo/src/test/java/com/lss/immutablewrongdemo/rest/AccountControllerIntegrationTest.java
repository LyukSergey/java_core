...
@SpringBootTest(classes = {ImmutableWrongDemoApplication.class, InitTestDataConfig.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
